...
const Home: React.FC = () => {
    ...
    return (
        <VStack flex={1} w='full' bgColor='gray.200'>
            <StatusBar variant='light' />
            <HStack h={32} py={8} px={6} bgColor='gray.900' justifyContent='space-between' alignItems='flex-end'>
                <Logo width={108} height={12} />
                <Text fontFamily='body' fontWeight='regular' fontSize='md' color='gray.600'>
                    Total de 12 carros
                </Text>
            </HStack>
            <FlatList
